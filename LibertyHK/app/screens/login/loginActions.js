...
export const login = (data,Callback)=>{
    return (dispatch) => {
        ...
        // End of this function flow dispatch action and/or navigate to other screens
        dispatch({type:ActionTypes.LOGIN_SUCCESS,data:{/*username:userInfo[0].username,login:true*/}})
    }
}
